...
{
  "transport": "http",
  "broker_base_url": "http://127.0.0.1:18095",
...
PORT=18095 TWOMAN_CONFIG_PATH="$TMP_DIR/broker-config.json" node "$ROOT/host/node_selector/broker.js" \
...
wait_for_port 127.0.0.1 28082 http-helper
wait_for_port 127.0.0.1 21082 socks-helper

curl --fail --silent --show-error \
  --socks5-hostname "127.0.0.1:21082" \
